...
import "../../tokens/AntiBotStandardToken.sol";
...
contract AntiBotStandardTokenFactory is TokenFactoryBase {
    ...
    function create(
        ...
        AntiBotStandardToken btoken = new AntiBotStandardToken(
            msg.sender,
            name_,
            symbol_,
            decimals_,
        ...
        assignTokenToOwner(msg.sender, address(btoken), 4);
        emit TokenCreated(msg.sender, address(btoken), 4);
